...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Allow users to press the enter key to submit their answer
...
function runGame(gameType) {
    ...
    // Clears the answer box after each answer
    document.getElementById("answer-box").value = "";

    // Setting the focus - the cursor to be in the answer box as soon as the page is loaded
...
function displayDivisionQuestion(operand1, operand2) {
  ...
  //  if (operand1 === operand2) {
	...
	// Ensure the larger number is the dividend
